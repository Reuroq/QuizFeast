const SEO = {
  ...
  antiterrorism: { title: 'Antiterrorism Level 1 Answers', description: 'Complete AT Level 1 answers. 61 questions on FPCON, active shooter, IED, iSALUTE.', keywords: 'antiterrorism level 1 answers, AT level 1, FPCON levels' },
  hipaa_privacy: { title: 'HIPAA & Privacy Act Training Answers', description: 'Complete HIPAA answers. 58 questions on PHI, breach notification, patient rights.', keywords: 'HIPAA training answers, Privacy Act answers' },
  law_of_war: { title: 'Law of War Answers', description: 'Complete Law of War answers. 56 questions on Geneva Conventions, ROE, targeting, war crimes.', keywords: 'law of war answers, LOAC answers' },
  ...
  ctip: { title: 'CTIP Answers — Combating Trafficking in Persons', description: 'Complete CTIP answers. 50 questions on trafficking indicators, DoD policy, TVPA.', keywords: 'CTIP answers, combating trafficking answers' },
  ...
  driving_for_life: { title: 'Driving for Life Answers', description: 'Complete Driving for Life answers. 40 questions on distracted driving, DUI, motorcycle safety.', keywords: 'driving for life answers, POV safety' },
